...
#define __set0_io(var,bit)       __asm__("set0.io "_STR_VAR(var)", #"_STR(bit)"\n")
#define __set1_io(var,bit)       __asm__("set1.io "_STR_VAR(var)", #"_STR(bit)"\n")
#define __set0_mem(var,bit)       __asm__("set0 "_STR_VAR(var)", #"_STR(bit)"\n")
#define __set1_mem(var,bit)       __asm__("set1 "_STR_VAR(var)", #"_STR(bit)"\n")
