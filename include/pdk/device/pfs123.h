/*
  pfs123.h: FUSE and Register Definitions for the Padauk PFS123 device.
...
#define __PDK_DEVICE_PFS123_H__
	...
	#error "PFS123 needs the PDK15 backend. You must compile with the -mpdk15 option."
#endif
